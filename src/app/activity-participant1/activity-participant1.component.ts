...
@Component({
  selector: 'app-activity-participant1',
  templateUrl: './activity-participant1.component.html',
  styleUrls: ['./activity-participant1.component.css']
})
export class ActivityParticipant1Component {
  ...
  constructor(private fetchData: FetchService) {
    this.fetchData.fetchActivityArrayData({ email1: 'agitationtrial001@gmail.com', email2: 'agitationtrial002@gmail.com' }).subscribe((res) => {
      console.log(res);
      this.details = res;
