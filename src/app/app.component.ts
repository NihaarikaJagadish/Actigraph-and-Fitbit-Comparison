  ...
  constructor() {
    this.chartOptions = {
      series: [
        {
          name: "Actigraph",
          data:[94, 93, 88, 93, 95, 90, 95, 93, 81, 92]
        },
        {
          name: "Fitbit",
      ...
      xaxis: {
        categories: ['07-28', '07-29', '07-29', '07-30', '08-01', '08-04', '08-05', '08-06', '08-07', '08-08'],
        title: {
          text: "Dates"
        }
      },
    ...
    this.avgAwakeningInMinutes = {
      series: [
        {
          name: "Actigraph",
          data:[1.76, 1.6875, 2.15, 1.8, 1.17, 1.8, 1.45, 2.33, 2.05, 1.07]
        },
        {
          name: "Fitbit",
          data: [3.1, 3.66, 6.53, 4.13, 3.39, 2.68, 3.23, 4.3, 2.86, 2.14]
        }
      ],
      chart: {
        height: 350,
    ...
    this.awakeningCount = {
      series: [
        {
          name: "Actigraph",
          data:[13, 16, 26, 15, 17, 20, 9, 11, 19, 13]
        },
        {
          name: "Fitbit",
    ...
    this.timeAsleep = {
      series: [
        {
          name: "Actigraph",
          data:[361, 373, 414, 391, 422, 325, 336, 281, 481, 382]
        },
        {
          name: "Fitbit",
          data: [341, 338, 366, 593, 379, 322, 434, 360, 387, 358]
        }
      ],
      chart: {
        height: 350,
    ...
    this.timeAwake = {
      series: [
        {
          name: "Actigraph",
          data:[23, 27, 56, 27, 20, 36, 16, 21, 39, 14]
        },
        {
          name: "Fitbit",
          data: [56, 66, 98, 105, 78, 51, 47, 86, 66, 58]
        }
      ],
      chart: {
        height: 350,
    ...
    this.outBedTime = {
      series: [
        {
          name: "Actigraph",
          data: [101,109,66,4,155,100,134,71,250,137]
        },
        {
          name: "Fitbit",
          data: [103, 105, 56, 129, 153, 101, 129, 207, 203, 149]
        }
      ],
      chart: {
        height: 350,
